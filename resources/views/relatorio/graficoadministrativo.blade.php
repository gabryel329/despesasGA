...
<main class="app-content">
    ...
    <div class="app-title">
      ...
      <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Graficos Administrativo</a></li>
      </ul>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="widget-small info coloured-icon"><i class="icon fa fa-thumbs-o-up fa-3x"></i>
            <div class="info">
                <h4>Reembolsos<br><span><p style="font-size: smaller;">(Glosados)</p></span></h4>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="widget-small warning coloured-icon"><i class="icon fa fa-files-o fa-3x"></i>
          <div class="info">
            <h4>Reembolsos<br><span><p style="font-size: smaller;">(Em Abertos)</p></span></h4>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="widget-small danger coloured-icon"><i class="icon fa fa-star fa-3x"></i>
          <div class="info">
            <h4>Reembolsos<br><span><p style="font-size: smaller;">(Reembolsados)</p></span></h4>
...
<script type="text/javascript">
        ...
        function drawChart() {
          ...
          formatter.format(data, 1); // Formata a coluna 1 (Valor) em formato de moeda
