                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="gasto_id" name="gasto_id">
                                        ...
                                        @foreach ($gastos as $gasto)
                                            <option value="{{$gasto->id}}">{{$gasto->nome}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" id="status" name="status">
                                        ...
                                        <option value="2">Reembolsada</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
